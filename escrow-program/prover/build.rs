...
fn main() {
    ...
    println!("cargo:rerun-if-changed=circuits/escrow/escrow.go");
    println!("cargo:rerun-if-changed=circuits/withdraw/withdraw.go");
    println!("cargo:rerun-if-changed=circuits/witness/witness.go");
    println!("cargo:rerun-if-changed=circuits/escrowterms/escrowterms.go");
